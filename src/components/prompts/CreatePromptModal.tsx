            ...
            >
                    ...
                    <div className="flex items-start justify-between gap-3" id="create-prompt-header-row">
                        <div className="flex items-center gap-2" id="create-prompt-header-left">
                            ...
                            <div className="space-y-1" id="create-prompt-header-text">
                                <DialogTitle className="text-base font-semibold tracking-tight" id="create-prompt-title">
                                    New Prompt
                                </DialogTitle>
                                <DialogDescription
                                ...
                                >
                                    Create a reusable prompt template. Use <span className="font-mono">{"{{variable}}"}</span> for variables.
                                </DialogDescription>
                            </div>
                        </div>
                    </div>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="flex-1 flex flex-col min-h-0" id="create-prompt-form">
                        ...
                        <DialogFooter className="px-6 py-4 bg-muted/30 gap-3 sm:gap-0" id="create-prompt-footer">
                            <div className="flex items-center justify-between w-full" id="create-prompt-footer-row">
                                <div className="flex items-center gap-2" id="create-prompt-footer-left">
                                    <Button
                                        type="button"
                                        variant="ghost"
                                        size="sm"
                                ...
                                <div className="flex items-center gap-2" id="create-prompt-footer-right">
                                    <Button
                                        type="submit"
                                        disabled={isLoading}
                                        size="sm"
