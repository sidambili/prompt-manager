                ...
                <div className="flex flex-col gap-4 w-full max-w-xs mb-8">
                    <div className="relative">
                        ...
                        {!oauthProviders.github && !oauthLoading && (
                            <p className="text-xs text-muted-foreground mt-1 text-center">GitHub OAuth not configured</p>
                        )}
                    </div>
                    <div className="relative">
                        <Button
                        ...
                        {!oauthProviders.google && !oauthLoading && (
                            <p className="text-xs text-muted-foreground mt-1 text-center">Google OAuth not configured</p>
                        )}
                    </div>
                </div>
